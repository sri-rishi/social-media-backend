...
const { createPost, getSinglePost, updatePost, deletePost, likePost, getTimelinePosts, createComment, deleteComment, sharePost } = require("../controllers/post.controller");
